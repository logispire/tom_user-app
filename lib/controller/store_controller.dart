...
class StoreController extends GetxController implements GetxService {
  ...
  List<String> _openedStores = [];
  List<String> get openedStores => _openedStores;
  Future<void> getStoreList(int offset, bool reload) async {
    ...
    if (response.statusCode == 200) {
      if (offset == 1) {
        ...
        _openedStores = await storeRepo.setOpenedStores(_storeModel!.stores!);
        print('opened stores $_openedStores');
      } else {
